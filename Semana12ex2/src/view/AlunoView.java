//Nome do grupo: Daniel Facina, Leandro Motta, Pamela Pereira
...
*/
	...
	private String AcessS = "r";	//Para acessar Consultar
    ...
    public AlunoView(){
		...
		nomeGrupo = new JLabel("Grupo: Daniel Facina, Leandro Motta, Pamela Pereira");
